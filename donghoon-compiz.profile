...
s0_rotate_left_key = <Control><Super>Left
s0_rotate_left_button = Disabled
s0_rotate_right_key = <Control><Super>Right
...
[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;copytex;decor;grid;imgpng;matecompat;mousepoll;move;regex;resize;screenshot;shift;water;winrules;wobbly;animation;commands;fade;cube;expo;gears;rotate;switcher;wizard;ring;
...
[cube]
s0_unfold_key = <Control><Super>Down
s0_mipmap = true
s0_multioutput_mode = 0
s0_in = false
s0_acceleration = 4.000000
...
[shift]
s0_initiate_key = <Control><Alt>Down
