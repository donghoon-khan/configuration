...
typeset POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon user dir dir_writable vcs)
...
typeset POWERLEVEL9K_{SSH,HOST,USER}_ICON='\uF109'
typeset POWERLEVEL9K_{HOST,USER}_FOREGROUND=123
